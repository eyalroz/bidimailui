pref("extensions.bidiui.mail.compose.default_direction", "ltr");
pref("extensions.bidiui.mail.compose.reply_in_default_direction", false);
pref("extensions.bidiui.mail.compose.show_direction_buttons", true);
pref("extensions.bidiui.mail.compose.space_between_paragraphs.value", "0");
pref("extensions.bidiui.mail.compose.space_between_paragraphs.scale", "cm");

// Hidden prefs
pref("extensions.bidiui.mail.display.autodetect_direction", true);
